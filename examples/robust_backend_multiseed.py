...
def run_seed(seed: int, noise_std: float = 0.5) -> Result:
    provider = BenchmarkProvider(peak_temp=35.0, price_mode="standard", seed=seed, noise_std=noise_std)
